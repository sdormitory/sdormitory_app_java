...
import cn.sdormitory.common.enums.HttpMethod;
import cn.sdormitory.common.manager.AsyncManager;
import cn.sdormitory.common.manager.factory.AsyncFactory;
...
public class WebLogAspect {
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.sdormitory.common.annotation.SysLog)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 请求的地址
            String ip = IpAddressUtil.getIpAddr(ServletUtils.getRequest());
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, SysLog log, SysOperationLog operLog) throws Exception {
        // 设置action动作
