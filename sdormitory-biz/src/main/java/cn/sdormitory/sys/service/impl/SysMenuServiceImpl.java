...
import cn.sdormitory.sys.dao.SysMenuDao;
import cn.sdormitory.sys.entity.SysMenu;
import cn.sdormitory.sys.enums.MenuTypeEnums;
import cn.sdormitory.sys.service.SysMenuService;
import cn.sdormitory.sys.service.SysRoleMenuService;
import cn.sdormitory.sys.vo.MetaVo;
import cn.sdormitory.sys.vo.RouterVo;
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId) {
        ...
        if (SecurityUtils.isAdmin(userId)) {
            menus = list(new LambdaQueryWrapper<SysMenu>()
                    .in(SysMenu::getType, Arrays.asList(MenuTypeEnums.CATALOG.getValue(), MenuTypeEnums.MENU.getValue())).orderByAsc(SysMenu::getSort));
        } else {
