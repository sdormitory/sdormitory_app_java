...
import cn.sdormitory.common.utils.EncryptUtils;
...
public class OnlineUserServiceImpl implements OnlineUserService {
    ...
    public void save(SysUser sysUser, String token, String expiration, HttpServletRequest request) {
        String job = sysUser.getDeptName();
        ...
        log.info("{},{},{},{},{},{},{},{},{}", ONLINE_KEY + token, sysUser.getId(), sysUser.getUsername(), ip, address, browser, new Date(), new Date());
